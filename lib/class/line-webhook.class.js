...
class LineDialogflow {
    constructor(lineConfig, dialogflowConfig) {
        ...
        this.handleImage = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        this.handleVideo = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        this.handleAudio = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        this.handleFile = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        this.handleLocation = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        this.handleSticker = (event) => __awaiter(this, void 0, void 0, function* () {
            return this.replyText(event.replyToken, `收到`);
        });
        ...
        this.handleJoin = (event) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.handleBeacon = (event) => __awaiter(this, void 0, void 0, function* () {
